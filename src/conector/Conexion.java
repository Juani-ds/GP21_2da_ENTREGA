...
public class Conexion {
    private static final String URL = "jdbc:mariadb://localhost/gp21_universidad";
    ...
    public static Connection getConexion() {
        if (con == null) {
            try {
                Class.forName("com.mysql.cj.jdbc.Driver"); // o "com.mysql.cj.jdbc.Driver" según el conector
